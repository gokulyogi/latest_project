<%@ Page Language="C#" MasterPageFile="~/site/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="page1.aspx.cs" Inherits="site_admin_Default" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 95%; height: 256px">
        <tr>
            <td>
                &nbsp;</td>
            <td>
