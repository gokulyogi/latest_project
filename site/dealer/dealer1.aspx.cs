...
public partial class site_dealer_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            str = "select isnull(max(ID),0)+1 from tblcars";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
            ...
            str = "insert into tblcars values('" + Label11.Text + "','" + DropDownList1.Text + "','" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + Image1.ImageUrl + "','" + Image2.ImageUrl + "','" + Image3.ImageUrl + "','" + Image4.ImageUrl + "','" + Image5.ImageUrl + "','" + Image6.ImageUrl + "','" + TextBox6.Text + "','" + Session["dealer"].ToString() + "')";
            ...
            if (n == 1)
            {
                ...
                {
                    SqlCommand smd = new SqlCommand("insert into color(id,color)values('" + Convert.ToInt32(Label11.Text) + "','" + ListBox1.Items[i].ToString() + "')", con);
                    smd.ExecuteNonQuery();
                }
            }
            con.Close();
